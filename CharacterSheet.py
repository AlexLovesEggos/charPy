...
# Strength      {ss(character.strength)} {ss(pos(character.modifiers['str']))} # {ss("Strength",18,False)}{ss(pos(character.saves['str']),3)} #=====================# 
# Dexterity     {ss(character.dexterity)} {ss(pos(character.modifiers['dex']))} # {ss("Dexterity",18,False)}{ss(pos(character.saves['dex']),3)} # DEATH SAVES         #
# Constitution  {ss(character.constitution)} {ss(pos(character.modifiers['con']))} # {ss("Constitution",18,False)}{ss(pos(character.saves['con']),3)} # Successes [ ][ ][ ] #
# Intelligence  {ss(character.intelligence)} {ss(pos(character.modifiers['int']))} # {ss("Intelligence",18,False)}{ss(pos(character.saves['int']),3)} # Failures  [ ][ ][ ] #
# Wisdom        {ss(character.wisdom)} {ss(pos(character.modifiers['wis']))} # {ss("Wisdom",18,False)}{ss(pos(character.saves['wis']),3)} #=====================# 
# Charisma      {ss(character.charisma)} {ss(pos(character.modifiers['cha']))} # {ss("Charisma",18,False)}{ss(pos(character.saves['cha']),3)} #
#=====================#=======================#=====================#
