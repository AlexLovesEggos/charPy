...
class Character:
    ...
    def classicConsole(self,space=22):
        ...
        col1 = [rowSep]
        col1.append(it(self.name))
        col1.append(it('Level ' + str(self.level)))
        col1.append(it(self.charclass))
        col1.append(it(self.subclass))
        col1.append(rowSep)
        for i in range(6):
            l = it(self.abilityNames[i],self.abilityScores[i],pStr(self.modifiers[self.abilityTags[i]]))
            col1.append(l)
        col1.append(rowSep)
        col1.append(it('Passive',self.passivePerception))
        col1.append(it('Perception'))
        col1.append(rowSep)
        for i in range(5):
